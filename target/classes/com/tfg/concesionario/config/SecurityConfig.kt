        ...
        http
            ...
            .authorizeHttpRequests {
                it
                    ...
                    .requestMatchers("/motosNuevas/**").permitAll()
                    .requestMatchers("/imagenesMotoNueva/moto/**").permitAll()
                    .requestMatchers("/imagenesMotoNueva/upload").hasAnyRole("ADMIN", "VENDEDOR")
                    .requestMatchers("/imagenesMotoNueva/**").hasAnyRole("ADMIN", "VENDEDOR")
                    .requestMatchers("/videosMotoNueva/**").hasAnyRole("ADMIN", "VENDEDOR")
